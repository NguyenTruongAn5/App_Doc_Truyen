...
public class APILayUsers extends AsyncTask<Void, Void, Void> {

    String data;
    LayTruyenVe layTruyenVe;

    public APILayUsers(LayTruyenVe layTruyenVe) {
    ...
    protected Void doInBackground(Void... voids) {
        ...
        Request request = new Request.Builder()
                .url("https://mitdthu.000webhostapp.com/data_dang_nhap.php")
                .build();
        data = null;
        try {
